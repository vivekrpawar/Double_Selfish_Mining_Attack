...
class Node:
    def __init__(self, node_id, coins ,hashing_power, is_slow, is_slow_cpu, exp_dist_mean, event_queue):
        ...
        self.blocks = {     #dictionary of all blocks node has seen
            0: Block(block_id=0,created_by=self.node_id,mining_time=0,prev_block_id = -1, transactions=[],
                    length_of_chain=0, timestamp=time.time())
        }
    ...
    def receive_block(self, block):
        with open('file.txt', 'a') as file:
            file.write("Block: "+str(block.block_id)+" recieved by= "+str(self.node_id)+" at time: "+str(time.time())+" \n")
